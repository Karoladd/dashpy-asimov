...
layout = dbc.Card([
     html.H1("UDIT", className="text-primary"),
                html.P("Por: Union Digital IT", className="text-info"),
                html.Hr(),
...
# Seção NAV ------------------------
            ...
            dbc.Nav(
                [
                    ...
                    dbc.NavLink("Atual", href="/atual", active="exact"),
                    dbc.NavLink("Geral", href="/geral", active="exact"),
